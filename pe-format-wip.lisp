...
;; note: I'm skipping the rich headers as they are optional (and rather undocumented)
...
(define-io-structure image-data-directory
  (virtual-address uint32)
  (size uint32))

(defconstant +image-numberof-directory-entries+ 16)
...
(define-io-structure image-optional-header-64
  ...
  (data-directory (vector image-data-directory
                          #.+image-numberof-directory-entries+)))
